...
export function Hero() {
  ...
  // All SVG strokes and fills reference these instead of hardcoded hex.
  const ink = isDark ? "#8a8d9a" : "#5a5750"; // secondary strokes, labels
  const org = isDark ? "#f2740d" : "#d4610a"; // orange accent
  const light = isDark ? "#ede9df" : "#1e1c18"; // ruler ticks, wavy underline
  ...
  return (
    <>
      ...
      <section className="hero grid-paper">
        ...
        <div className="ruler" aria-hidden="true">
          {[
            ...
            <div key={i} className="ruler-tick">
              <div style={{ width: tick.w, height: 1, background: light }} />
        ...
        >
          ...
          >
            ...
            <line
              ...
              strokeWidth="0.7"
            />
            <path d="M8 36 Q26 4 44 36" stroke={org} strokeWidth="0.9" />
            <text
              x="28"
              y="12"
              fontFamily="Courier Prime,monospace"
        ...
        >
          <span>edactly / edu platform</span>
          <svg
            viewBox="0 0 52 32"
          ...
          >
            ...
            />
            <circle cx="26" cy="16" r="2.5" stroke={org} strokeWidth="0.7" />
            <circle cx="48" cy="16" r="1.2" fill={ink} opacity="0.6" />
          </svg>
        </div>
        ...
        >
          ...
          <svg
            ...
            fill="none"
          >
            <path d="M4 32 L24 4 L44 32 Z" stroke={ink} strokeWidth="0.7" />
            <path
              d="M4 32 Q8 28 10 32"
              stroke={org}
              strokeWidth="0.6"
        ...
        >
          ...
          >
            ...
            <path
              ...
              fill="none"
            />
            <circle cx="14" cy="44" r="1.5" fill={org} opacity="0.7" />
            <circle cx="22" cy="34" r="1.5" fill={org} opacity="0.7" />
            <circle cx="34" cy="22" r="1.5" fill={org} opacity="0.7" />
            <circle cx="42" cy="14" r="1.5" fill={org} opacity="0.7" />
            <circle cx="46" cy="10" r="1.5" fill={org} opacity="0.7" />
            <text
              x="52"
              y="28"
              fontFamily="Courier Prime,monospace"
        ...
        >
          <svg
            ...
            fill="none"
          >
            <path d="M4 52 L4 12 L44 52 Z" stroke={ink} strokeWidth="0.7" />
            <path
              d="M4 40 L8 40 L8 44"
              stroke={ink}
              strokeWidth="0.5"
          ...
          >
            ...
            >
              <path
                ...
                stroke={`rgba(${isDark ? "242,116,13" : "212,97,10"},0.6)`}
                strokeWidth="1.4"
                opacity="0.42"
              />
              <path
